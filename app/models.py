...
class Country(models.Model):
    ...
    open_street_map_url = models.URLField(max_length=1000, blank=True)
    ...
    flag_png = models.URLField(max_length=1000, blank=True)
    flag_svg = models.URLField(max_length=1000, blank=True)
    flag_alt = models.CharField(max_length=2000, blank=True)
    coat_of_arms_png = models.URLField(max_length=1000, blank=True)
    coat_of_arms_svg = models.URLField(max_length=1000, blank=True)
